        ...
        <div class="p-4 space-y-3">
          <div class="flex items-start justify-between gap-2">
            ...
            <div class="flex items-center gap-2 shrink-0">
              ...
              <span v-if="tts.settings.defaultProvider === selectedTtsProviderMeta.id" class="text-[10px] text-emerald-600">默认</span>
            ...
            >
              <div class="flex-1 min-w-0">
                <div class="flex items-center gap-2">
                  ...
                  <span v-if="isCurrentTtsVoice(voice)" class="text-[10px] text-emerald-600 shrink-0">当前</span>
                </div>
