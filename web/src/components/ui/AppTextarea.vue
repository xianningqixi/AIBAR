...
<template>
  <textarea
    ...
    :rows="rows ?? 4"
    :disabled="disabled"
    class="w-full rounded-xl bg-surface border border-border px-3 py-2 text-base leading-relaxed md:text-sm text-ink-primary placeholder-ink-muted transition-[height,border-color,box-shadow] duration-150 hover:border-border-strong focus:outline-none focus:border-brand-500/70 focus:ring-2 focus:ring-brand-500/30 focus:shadow-glow disabled:opacity-50 disabled:cursor-not-allowed resize-y"
